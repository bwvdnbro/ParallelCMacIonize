...
for f in testDensitySubGrid_omp.cpp CommandLineOption.cpp CommandLineParser.cpp
do
  g++ $flags $cflags $incs -c $f
done

g++ $flags $cflags -o testDensitySubGrid_omp \
  testDensitySubGrid_omp.o CommandLineOption.o CommandLineParser.o $libs
